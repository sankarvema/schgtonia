...
<div id="main">
    ...
    <div id="header">
        ...
        <hr class="noscreen" />
	      ...
	      <!-- Navigation -->
    <div id="nav2">
            <span class="topMenuItem"><a  href="Willekum.php"  target="innerframe">Willekumm</a></span>
			&nbsp;&nbsp;|&nbsp;&nbsp;
            <span class="topMenuItem"><a href="UnsreBurg.php"  target="innerframe">Galerie</a></span>
			&nbsp;&nbsp;|&nbsp;&nbsp;
