...
<div id="main">
    ...
    <div id="header">
        ...
        <hr class="noscreen" />
	      ...
	      <!-- Navigation -->
    <div id="nav2">
            <a href="Willekum.php"  target="innerframe">Willekumm</a>&nbsp;&nbsp;|&nbsp;&nbsp;
            <a href="UnsreBurg.php"  target="innerframe">Galerie</a>&nbsp;&nbsp;|&nbsp;&nbsp;
            <a href="100Jahre.php"  target="innerframe">100 Jahre</a>&nbsp;&nbsp;|&nbsp;&nbsp;
			<a href="Einfuehrung.php" target="innerframe">Einf&#252;hrung</a>&nbsp;&nbsp;|&nbsp;&nbsp;
            <!--<a href="Aktuell.php" target="innerframe">Aktuell</a>&nbsp;&nbsp;|&nbsp;&nbsp;-->
			<a href="Impressum.php" target="innerframe">Impressum</a>&nbsp;&nbsp;|&nbsp;&nbsp;
			<a href="Ehrenritter.php" target="innerframe">Ehrenritter</a>&nbsp;&nbsp;|&nbsp;&nbsp;
			<!--<a href="fonts.htm" target="innerframe">Trials Fonts</a>-->
    </div> <!-- /nav -->

	<iframe src="Willekum.php"  width="100%" height="1740px" frameborder="0px" id="innerframe" name="innerframe"></iframe>
    


    <!-- Footer -->
    <div id="footer">
        <p>&copy;&nbsp;2013 <a href="/">Schlaraffia Washingtonia</a></p>
    </div> <!-- /footer -->
